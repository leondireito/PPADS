        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Serie_Diretor = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Midias_Editoras_EditoraId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AutorLivro_Midias_LivrosId",
                        column: x => x.LivrosId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ElencosId = table.Column<int>(type: "INTEGER", nullable: false),
                    FilmesId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ElencoFilme", x => new { x.ElencosId, x.FilmesId });
                    table.ForeignKey(
                        name: "FK_ElencoFilme_Elenco_ElencosId",
                        column: x => x.ElencosId,
                        principalTable: "Elenco",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ElencoFilme_Midias_FilmesId",
                        column: x => x.FilmesId,
                        principalTable: "Midias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ElencoSerie", x => new { x.ElencosId, x.SeriesId });
                    table.ForeignKey(
                        name: "FK_ElencoSerie_Elenco_ElencosId",
                        column: x => x.ElencosId,
                        principalTable: "Elenco",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ElencoSerie_Midias_SeriesId",
                        column: x => x.SeriesId,
                        principalTable: "Midias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
